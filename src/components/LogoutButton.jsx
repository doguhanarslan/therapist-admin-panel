...
const LogoutButton = () => {
  ...
  return (
    <button
      ...
      type="button"
      className="inline-flex items-center justify-center bg-red-50 text-red-600 py-2 px-4 rounded-md font-medium hover:bg-red-100 transition-colors active:bg-red-200 cursor-pointer whitespace-nowrap"
    >

    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-white p-4">
      <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-md shadow-md text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 cursor-pointer"
              >
                {loading ? (
        ...
        <div className="mt-4 text-center text-sm text-gray-500">
          <p>Ruh sağlığı profesyonelleri için güvenilir platform</p>
          <p className="mt-2 text-xs">
            © {new Date().getFullYear()} TerapiWon. Tüm hakları saklıdır.
          </p>
        </div>
      </div>
    </div>
